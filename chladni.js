...
class ChladniSimulator {
  constructor(besselRootsTable) {
    ...
    _setupGPUSimulation() {
        ...
        this.gpuCompute = new GPUComputationRenderer(fdmTexSize, fdmTexSize, this.renderer);
        ...
        this.gpuCompute.renderTargets[this.fdmVariable.name] = this.gpuCompute.createRenderTarget(fdmTexSize, fdmTexSize, THREE.NearestFilter, THREE.NearestFilter, THREE.RepeatWrapping, THREE.RepeatWrapping);
        this.gpuCompute.renderTargets[this.fdmVariable.name].texture.format = THREE.RGBAFormat;
    ...
    _updateSubtitles() {
        ...
        if (!this.isSubtitlesEnabled || !subContainer || !this.audioElement) {
            if (subContainer.textContent !== '') subContainer.textContent = '';
